...
The output is a `04-regression-scope.md` — mapping the feature to impacted subsystems with risk levels, a runnable smoke suite, and prioritized validation recommendations.
...
2. Check the current directory for `03-test-cases.md` and `02-test-plan.md`; read them if present
...
10. Save as `04-regression-scope.md` in the same directory as other QE artifacts
