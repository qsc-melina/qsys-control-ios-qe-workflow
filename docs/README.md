...
| Feature | Test Plan | Test Cases | Jira Story |
|---|---|---|---|
| Device Discovery | [`test-plan.md`](../examples/device-discovery/test-plan.md) | [`test-cases.md`](../examples/device-discovery/test-cases.md) | [`jira-story.md`](../examples/device-discovery/jira-story.md) |
| Popup Visibility & Layer Transitions | [`test-plan.md`](../examples/popup-visibility/test-plan.md) | [`test-cases.md`](../examples/popup-visibility/test-cases.md) | [`jira-story.md`](../examples/popup-visibility/jira-story.md) |
...
3. Run `/qe:test-cases` and `/qe:jira-stories` to complete the QE artifact set
4. Run `/opsx:apply` to implement the change tasks
5. Run `/opsx:archive` when the change and QE sign-off are complete
